...
var WarehouseService = /** @class */ (function () {
    ...
    WarehouseService.countItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var count;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, models_1.Warehose.countDocuments({})];
                    case 1:
                        count = _a.sent();
    ...
    WarehouseService.getAllWarehouses = function () {
        return __awaiter(this, void 0, void 0, function () {
            var body, data, filterdWarehouses;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        body = {
                ...
                switch (_d.label) {
                    case 0:
                        ...
                        input = queryData
                            ...
                            : {};
                        return [4 /*yield*/, models_1.Warehose.find(input)
                                .limit(limit)
                                .skip(skip)];
                    case 1:
...
//# sourceMappingURL=warehouse.serice.js.map